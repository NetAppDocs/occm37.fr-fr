...
[role="lead"]
Cloud Manager nécessite des autorisations pour effectuer des actions dans votre fournisseur cloud. Ces autorisations sont incluses dans https://mysupport.netapp.com/info/web/ECMP11022837.html["Règles fournies par NetApp"^]. Vous pouvez comprendre ce que fait Cloud Manager avec ces autorisations.
