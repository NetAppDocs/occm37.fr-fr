...
----
+
Ces actions sont incluses dans la dernière https://mysupport.netapp.com/cloudontap/iampolicies["Politique de Cloud Manager"^]. Les nouveaux systèmes déployés à partir de NetApp Cloud Central incluent automatiquement ces autorisations.
